<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucFileBrowser.ascx.cs" Inherits="FileBrowser.FileBrowser.ucFileBrowser" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <input id="HF_CustomRoots" type="hidden" runat="server" 
         ...
         />
        <div>
            <iz:FileManager ID="FileManager1" runat="server" Height="600" Width="960" ImagesFolder="~/FileBrowser/img/cmd"
                MainDirectory="~/DataStore/userfiles" CustomThumbnailHandler="~/FileBrowser/IZWebFileManagerThumbnailHandler.ashx"
