<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPhoneBook.ascx.cs" Inherits="Pvn.Web.Usercontrols.ucPhoneBook" %>
<div style="display:inline-block;font-size:12px;">
   
</div>
<asp:UpdatePanel ID="phoneBookUpdatePanel" runat="server">
    <ContentTemplate>
        <div class="list-search">
	        <div class="list-search-title"></div>    
        ...
        <hr />
        <div class="fr">            
            <a href="javascript:exportFromHTML()" class="exportexcel">In</a>
        </div> 
