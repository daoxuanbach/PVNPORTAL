<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNewsDetail2.ascx.cs" Inherits="PvnEN.Web.Usercontrols_EN.ucNewsDetail2" %>
<div class="container-fluid news_mobile">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="post-title bot-m20">
                    <h2 class='post-title bot-m20'><span> <asp:Literal ID="ltrTitle" runat="server"></asp:Literal></span></h2>
                            ...
                            <article id="post-1901" class="post-1901 post type-post status-publish format-standard has-post-thumbnail hentry category-chemical category-machinery category-metallurgy tag-company tag-manufacturing tag-metallurgy content">
                                <a href="<%# string.Format("{0}?NewsID={1}", UrlDetail, Eval("NewsPublishingID")) %>">
                                    <div class="blog-image clearfix">
                                        <asp:Image  ID="imgImage" runat="server" ToolTip='<%# Eval("Title") %>' ImageUrl='<%# Pvn.Utils.Utilities.ProcessImage(Eval("ImageURL"), "C150x86") %>'
