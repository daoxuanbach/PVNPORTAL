<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPhoto.ascx.cs" Inherits="PvnEN.Web.Usercontrols_EN.ucPhoto" %>
...
<script src="/wp-content/plugins/media/js/jquery.min.js"></script>
<script src="/wp-content/plugins/media/js/jquery.prettyPhoto.js"></script>
<link rel="stylesheet" href="/wp-content/plugins/media/css/prettyPhoto.css" type="text/css" media="screen" charset="utf-8" />
                                                        ...
                                                        <div class="image-overlay-container">
                                                            <div class="portfolio-info">
                                                                <h3 class="portfolio-title">
                                                                    <%# Pvn.Utils.Utilities.SplitString(Eval("Note").ToString(),MaxLengthTitle) %>
                                                                </h3>
                                                            </div>
                                                ...
                                                <div class="portfolio pvnPhotoGallery gallery" style="position: absolute; left: 0px; top: 0px;">
                                                    <a href="<%# Pvn.Utils.Utilities.ProcessImage(Eval("ImageURL"), OtherImageSize) %>" rel="prettyPhoto[gallery1]" title='<%# Eval("Desscription") %>'>
                                                        <div class="portfolio-image clearfix">
                                                            ...
                                                            AlternateText='<%# Eval("Note") %>' ImageUrl='<%# Pvn.Utils.Utilities.ProcessImage(Eval("ImageURL"), OtherImageSize) %>'
