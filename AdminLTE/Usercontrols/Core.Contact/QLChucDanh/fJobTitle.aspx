<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fJobTitle.aspx.cs" Inherits="AdminLTE.Usercontrols.QLChucDanh.fJobTitle" %>
...
<body>
    <form runat="server" id="frm">
        <div class="content-header row">
            <div class="col-xs-6">
                <strong class="text-uppercase">Chức danh/Titles</strong>
            </div>
            <div class="col-xs-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <input type="hidden" name="JobTitleID" value="<%=objItemET.JobTitleID %>">
                        <div class="box-body">
                            <div id="Thongbao">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Chức danh/Titles	</label>
                                        <input type="text" class="form-control" name="JobTitle" tabindex="1" placeholder="chức danh/Titles" data-validation="required" value="<%=objItemET.JobTitle %>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="JobTitleEng" tabindex="1" placeholder="JobTitleEng"  value="<%=objItemET.JobTitleEng %>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    $(function () {
        ...
        $.validate({
            ...
            onSuccess: function ($form) {
                // alert('ok');
                var urlPostAction = '/UserControls/Core.Contact/QLChucDanh/aJobTitle.ashx?action=add';
