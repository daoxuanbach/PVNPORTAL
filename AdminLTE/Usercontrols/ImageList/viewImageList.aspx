<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewImageList.aspx.cs" Inherits="AdminLTE.Usercontrols.ImageList.viewImageList" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".btn-add").click(function (event) {
            getPage("/UserControls/ImageList/fImageList.aspx?action=add");
        });
        $('.edit').click(function () {
            var ItemID = $(this).closest("td").attr('data-id')
            getPage("/UserControls/ImageList/fImageList.aspx?action=edit&ItemID=" + ItemID);
        });
        ...
        $("#cboImageCategoryID").select2("val", "<%=ImageCategoryID%>");
    ...
    function fndelete(dataid) {
        $.post(encodeURI("/UserControls/ImageList/aImageList.ashx"), { "CategoryID": dataid, "hidAction": "del" },
          function (data) {
              if (data.Error) {
    ...
    function fnSearch() {
        ...
        $.cookie("ImageCategoryID", $('#cboImageCategoryID').val(), { path: '/' });
...
<body>
    ...
    <form runat="server" id="frm">
        ...
        <div class="content-header row">
            <div class="col-xs-6">
                <strong class="text-uppercase">DANH SÁCH HÌNH ẢNH </strong>
            </div>
            <div class="col-xs-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%" id="cboImageCategoryID" tabindex="1" name="ImageCategoryID">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <asp:Repeater ID="rptDatabind" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td class=" actions">
                                                        <input class="checkSingle" type="checkbox" value="<%#Eval("ImageID") %>"></td>
                                                    <td><%#(Container.ItemIndex + 1) +  (CurPage-1)*RowPerPage %></td>
                                                    <td><%# Eval("ImageCategoryName")%></td>
                                                    <td>
                                                        <div>
                                                    ...
                                                    <td class="actions"  data-id="<%#Eval("ImageID") %>">
                                                        <%=ucChucNang.ChucNang %>
                                                        <%--<a class="edit" href="javascript:void(0)" data-id="<%#Eval("ImageID") %>" title="Xóa"><i class="fa fa-edit (alias)"></i></a>--%>

                                                    </td>
                                                    <%--<td class=" actions"><a class="delete" href="javascript:void(0)" data-id="<%#Eval("ImageID") %>" title="Xóa"><i class="fa fa-trash-o"></i></a></td>--%>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
