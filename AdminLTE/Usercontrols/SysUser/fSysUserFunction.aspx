<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fSysUserFunction.aspx.cs" Inherits="AdminLTE.Usercontrols.SysUser.fSysUserFunction" %>
                                    ...
                                    <asp:Repeater ID="rptDatabind" runat="server">
                                        <ItemTemplate>
                                            <tr class="<%#Eval("CheckUserFunction") %>">
                                                ...
                                                <td><%#Eval("FullName") %></td>
                                                 <td class=" actions">
                                                    <input class="checkSingle flat-red" type="checkbox" value="<%#Eval("FunctionID") %>" <%#Eval("CheckUserFunction") %>>
                                                </td>
                                               </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-Update").click(function () {
            ...
            $.post(encodeURI("/UserControls/SysUser/aSysUser.ashx"), {"UserID":"<%=UserID%>", "listuserfn": arrID, "hidAction": "updateuserfn" },
                function (data) {
                    if (data.Error) {
