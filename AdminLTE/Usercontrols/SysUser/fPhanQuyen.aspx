<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fPhanQuyen.aspx.cs" Inherits="AdminLTE.Usercontrols.SysUser.fPhanQuyen" %>
...
<body>
    <form runat="server" id="frm">
        <div class="content-header row">
            <div class="col-xs-6">
                <strong class="text-uppercase">Người dùng chức năng hệ thống:
                    <asp:Label ID="UserNameId" runat="server" CssClass="css-username"></asp:Label></strong>
            </div>
            <div class="col-xs-6">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="table-header">
                                            ...
                                            <th class="col-xs-19">Tên chức năng</th>
                                            <th class="align-left">
                                                chức năng   <input class="flat-red CheckAll"  id="input-0" type="checkbox" value=""> <label for= 'input-0' > <span class='cslchucnang' >Chọn tất</span></label> </th>
                                             
                                        </tr>
                                    </thead>
                                    <asp:Repeater ID="rptDatabind" runat="server" OnItemDataBound="rptDatabind_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="<%#Eval("CheckUserFunction") %>">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-Update").click(function () {
            ...
            $.post(encodeURI("/UserControls/SysUser/aSysUser.ashx"), {"UserID":"<%=UserID%>", "lstchucnang": arrID, "hidAction": "phanquyen" },
                function (data) {
                    if (data.Error) {
