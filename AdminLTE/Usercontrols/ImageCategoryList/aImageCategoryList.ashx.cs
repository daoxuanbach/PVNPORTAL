...
namespace AdminLTE.Usercontrols.ImageCategoryList
{
    ...
    /// </summary>
    public class aImageCategoryList : IHttpHandler
    {
        ...
        {
            CMS_ImageCategoryET objET = RequestEntity(context);
        ...
        private CMS_ImageCategoryET RequestEntity(HttpContext context)
        {
            CMS_ImageCategoryET objET = new CMS_ImageCategoryET();
            if (!string.IsNullOrEmpty(context.Request["ImageCategoryID"]))
                objET.ImageCategoryID = new Guid(context.Request["ImageCategoryID"]);
            if (!string.IsNullOrEmpty(context.Request["ParentImageCategoryID"]))
                objET.ParentImageCategoryID = new Guid(context.Request["ParentImageCategoryID"]);
