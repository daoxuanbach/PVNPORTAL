...
{
    public partial class viewRoom : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Pvn.Utils.LogFile.WriteLogFile("viewRoom", "Page_Load", ex.Message);
        ...
        private void BindData()
        {
            ...
            HttpCookie mySearch = new HttpCookie("RoomName");
            mySearch = Request.Cookies["RoomName"];
            if (mySearch != null && mySearch.Value != "")
            {
                RoomName = Server.UrlDecode((mySearch.Value)).Trim();
            }
            bool? _isActive=null;
            ...
            if (myUsedState != null && myUsedState.Value != "")
            {
                ...
                _isActive = UsedState == 1;
            }
            
            CMS_RoomDA objDA = new CMS_RoomDA();
            DataTable dt;
            bool? _isDeleted = null;
