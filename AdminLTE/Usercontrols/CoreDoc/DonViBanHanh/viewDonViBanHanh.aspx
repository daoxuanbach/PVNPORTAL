<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewDonViBanHanh.aspx.cs" Inherits="AdminLTE.Usercontrols.DonViBanHanh.viewDonViBanHanh" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".btn-add").click(function (event) {
            getPage("/UserControls/CoreDoc/DonViBanHanh/fDonViBanHanh.aspx?action=add");
        });
        $('.edit').click(function () {
            var ItemID = $(this).closest("td").attr('data-id')
            getPage("/UserControls/CoreDoc/DonViBanHanh/fDonViBanHanh.aspx?action=edit&ItemID=" + ItemID);
        });
    ...
    function fndelete(dataid) {
        $.post(encodeURI("/UserControls/CoreDoc/DonViBanHanh/aDonViBanHanh.ashx"), { "PageID": dataid, "hidAction": "del" },
            function (data) {
                if (data.Error) {
...
<body>
    ...
    <form runat="server" id="frm">
        ...
        <div class="content-header row">
            <div class="col-xs-6">
                <strong class="text-uppercase">DANH MỤC ĐƠN VỊ BAN HÀNH</strong>
            </div>
            <div class="col-xs-6">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <asp:Repeater ID="rptDatabind" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td class=" actions">
                                                        <input class="checkSingle" type="checkbox" value="<%#Eval("DonViBanHanhID") %>"></td>
                                                    ...
                                                    <td class=" actions" data-id="<%#Eval("DonViBanHanhID") %>">
                                                        <%=ucChucNang.ChucNang %>
                                                    </td>
