<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fLinhVucVanBan.aspx.cs" Inherits="AdminLTE.Usercontrols.LinhVucVanBan.fLinhVucVanBan" %>
...
<body>
    <form runat="server" id="frm">
        <div class="content-header row">
            <div class="col-xs-6">
                <strong class="text-uppercase">Lĩnh vực văn bản</strong>
            </div>
            <div class="col-xs-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <input type="hidden" name="LinhVucID" value="<%=objItemET.LinhVucID %>">
                        <div class="box-body">
                            <div id="Thongbao">
                            </div>
                            <div class="row">
    ...
    $(function () {
        ...
        $.validate({
            ...
            onSuccess: function ($form) {
                // alert('ok');
                var urlPostAction = '/UserControls/CoreDoc/LinhVucVanBan/aLinhVucVanBan.ashx?action=add';
