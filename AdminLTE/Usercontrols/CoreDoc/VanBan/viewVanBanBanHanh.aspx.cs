...
{
    public partial class viewVanBanBanHanh : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Pvn.Utils.LogFile.WriteLogFile("viewVanBanBanHanh", "SubString", ex.Message);
            }
        }
        private void BindData()
        {
            string TrangThaiVanBan=  string.Concat((short)Pvn.Utils.Common.Parameter.DocumentState.HuyXuatBan);
