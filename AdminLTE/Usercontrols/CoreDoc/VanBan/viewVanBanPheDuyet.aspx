<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewVanBanPheDuyet.aspx.cs" Inherits="AdminLTE.Usercontrols.VanBan.viewVanBanPheDuyet" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.view').click(function () {
            ...
            getPage("/UserControls/CoreDoc/VanBan/viewGuiPheDuyet.aspx?action=viewApproved&ItemID=" + ItemID);
        });
        ...
        $('.pheduyet ').click(function () {
            var ItemID = $(this).closest("td").attr('data-id')
            getPage("/UserControls/CoreDoc/VanBan/viewPheDuyet.aspx?action=pheduyet&ItemID=" + ItemID);
        });
