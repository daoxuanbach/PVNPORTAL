<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewVanBanThuHoi.aspx.cs" Inherits="AdminLTE.Usercontrols.VanBan.viewVanBanThuHoi" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.thuhoi').click(function () {
            var dataid = $(this).closest("td").attr('data-id');
            BootstrapDialog.confirm({
                title: 'Thông báo',
                message: 'Bạn có chắc chắn muốn thu hồi văn bản này?',
    ...
    function thuHoiVanBan(dataid) {
        
        $.post(encodeURI("/UserControls/CoreDoc/VanBan/aVanBan.ashx"), {"VanBanID": dataid, "hidAction": "thuhoi" },
        function (data) {
            if (data.Error) {
                ...
                getPage("/UserControls/CoreDoc/VanBan/viewVanBanThuHoi.aspx?action=view");
            }
        });
        return false;
    }
    function fnSearch() {
        ...
        postData(1, "/UserControls/CoreDoc/VanBan/viewVanBanThuHoi.aspx");
    }
</script>
<head runat="server">
    <title></title>
