<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewBanHanh.aspx.cs" Inherits="AdminLTE.Usercontrols.VanBan.viewBanHanh" %>
            ...
            <div class="col-xs-6">
                <div class="form-inline text-right">
                    <div class="form-group">
                        ...
                        <button type="submit" id="btn-Update" class="btn btn-success btn-sm pull-right"><i class="fa fa-check"></i><strong>Ban hành văn bản </strong></button>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".btn-back").click(function (event) {
            getPage("/UserControls/CoreDoc/VanBan/viewVanBanBanHanh.aspx?action=view");
            return false;
        });
        $.validate({
            form: '#frm',
