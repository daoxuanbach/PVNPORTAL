<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewVanBan.aspx.cs" Inherits="AdminLTE.Usercontrols.VanBan.viewVanBan" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".btn-add").click(function (event) {
            getPage("/UserControls/CoreDoc/VanBan/fVanBan.aspx?action=add");
        });
        $('.edit').click(function () {
            var ItemID = $(this).closest("td").attr('data-id')
            getPage("/UserControls/CoreDoc/VanBan/fVanBan.aspx?action=edit&ItemID=" + ItemID);
        });
        $('.view').click(function () {
            var ItemID = $(this).closest("td").attr('data-id')
            getPage("/UserControls/CoreDoc/VanBan/ChiTietVanBan.aspx?action=xuatban&ItemID=" + ItemID);
        });
    ...
    function fndelete(dataid) {
        $.post(encodeURI("/UserControls/CoreDoc/VanBan/aVanBan.ashx"), { "PageID": dataid, "hidAction": "del" },
          function (data) {
              if (data.Error) {
