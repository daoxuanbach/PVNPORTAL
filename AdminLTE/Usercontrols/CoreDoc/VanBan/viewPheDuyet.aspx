<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewPheDuyet.aspx.cs" Inherits="AdminLTE.Usercontrols.VanBan.viewPheDuyet" %>
...
<body>
    <form runat="server" id="frm">
        <div class="content-header row">
            <div class="col-xs-6">
                <strong class="text-uppercase">Xem sét văn bản </strong>
            </div>
            <div class="col-xs-6">
                <div class="form-inline text-right">
                    <div class="form-group">
                        ...
                        <div id="btn-Reject" class="btn btn-warning btn-sm pull-right"><i class="fa fa-check"></i><strong>Hủy phê duyệt </strong></div>
                        <button type="submit" id="btn-Update" class="btn btn-success btn-sm pull-right"><i class="fa fa-check"></i><strong>Phê duyệt văn bản </strong></button>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <span id="btnChonFile" data-row="0" tabindex="13" style="border: 0px" class="upx"></span>
                                                <ul id="listFileAttach">
                                                    <asp:Repeater ID="rptAttach" runat="server">
                                                        <ItemTemplate>
                                                            <a target="_blank" href="/UserControls/Upload/File/<%#Eval("FileServer")%>">File <%# Container.ItemIndex + 1 %></a>
                                                        </ItemTemplate>
                                                        <SeparatorTemplate>
                                                            ,
                                                        </SeparatorTemplate>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".btn-back").click(function (event) {
            getPage("/UserControls/CoreDoc/VanBan/viewVanBanPheDuyet.aspx?action=view");
            return false;
        });

        $("#btn-Reject").click(function (event) {
            $("#hidAction").val("reject");
            $("#frm").submit();
        });
        $.validate({
            form: '#frm',
