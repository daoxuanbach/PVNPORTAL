...
{
    public partial class viewVanBanPheDuyet : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Pvn.Utils.LogFile.WriteLogFile("viewVanBanPheDuyet", "SubString", ex.Message);
            }
        }
        private void BindData()
        {
            string TrangThaiVanBan=  string.Concat((short)Pvn.Utils.Common.Parameter.DocumentState.ChoPheDuyet);
