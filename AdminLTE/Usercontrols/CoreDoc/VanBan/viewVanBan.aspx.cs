...
{
    public partial class viewVanBan : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Pvn.Utils.LogFile.WriteLogFile("viewVanBan", "SubString", ex.Message);
            }
        }
        private void BindData()
        {
            string TrangThaiVanBan=  string.Concat((short)Pvn.Utils.Common.Parameter.DocumentState.DangSoanThao,
                    Pvn.Utils.Constants.COMMAR,
                    (short)Pvn.Utils.Common.Parameter.DocumentState.HuyXuatBan,
                    Pvn.Utils.Constants.COMMAR,
                    (short)Pvn.Utils.Common.Parameter.DocumentState.HuyPheDuyet);
            ...
            if (myUsedState != null && myUsedState.Value != "")
            {
                ...
                TrangThaiVanBan = UsedState.ToString();
            }
        ...
        private void BindComboBox()
        {
            try
            {
                ...
                rptLoaiVanBan.DataBind();
                 ...
                 var lstItem = Pvn.Utils.EnumHelper.ToListInValue(typeof(Pvn.Utils.Common.Parameter.DocumentState), TrangThaiVanBan);
                rptUsedState.DataSource = lstItem;
