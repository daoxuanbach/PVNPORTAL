<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fSysGroupFunction.aspx.cs" Inherits="AdminLTE.Usercontrols.SysGroup.fSysGroupFunction" %>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="table-header">
                                            ...
                                            <th class="col-xs-11">Tên chức năng</th>
                                    ...
                                    <asp:Repeater ID="rptDatabind" runat="server">
                                        <ItemTemplate>
                                            <tr class="<%#Eval("CheckGroupFunction") %>">
                                                ...
                                                <td><%#Eval("FullName") %></td>
                                                   <td class=" actions">
                                                    <input class="flat-red checkSingle" type="checkbox" value="<%#Eval("FunctionID") %>" <%#Eval("CheckGroupFunction") %>>
                                                </td>
                                              </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-Update").click(function () {
            ...
            $.post(encodeURI("/UserControls/SysGroup/aSysGroup.ashx"), { "GroupID": "<%=GroupID%>", "listuserfn": arrID, "hidAction": "updateGroupfn" },
                function (data) {
                    if (data.Error) {
