...
{
    public partial class viewVideoCategoryList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                Page.Title = Resources.vi.viewVideoCategoryList;
                RequestPage();
                //ShowWorkRemind();
                if (!IsPostBack)
                {
            ...
            {
                Pvn.Utils.LogFile.WriteLogFile("viewVideoCategoryList", "Page_Load", ex.Message);
            }
        }
        private void BindData()
        {
            ...
            {
                Pvn.Utils.LogFile.WriteLogFile("viewVideoCategoryList", "BindData", ex.Message);
            }
