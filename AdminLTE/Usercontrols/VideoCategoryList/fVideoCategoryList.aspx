<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fVideoCategoryList.aspx.cs" Inherits="AdminLTE.Usercontrols.VideoCategoryList.fVideoCategoryList" %>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-info">
                        ...
                        <input type="hidden" name="VideoCategoryID" value="<%=objItemET.VideoCategoryID %>">
                        <div class="box-body">
                            <div id="Thongbao">
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%" id="cboParentVideoCategoryID" tabindex="6" name="cboParentVideoCategoryID">
...
<script type="text/javascript">
    $(function () {
        ...
        $.validate({
            ...
            onSuccess: function ($form) {
                // alert('ok');
                var urlPostAction = '/UserControls/VideoCategoryList/aVideoCategoryList.ashx?action=add';
        ...
        $('.cboLanguage').on('select2:select', function () {
            $.post("/UserControls/Service/getVideoCategoryByNgonNgu.ashx", { "NgonNgu": $(this).val() }, function (data) {
                $("#cboParentVideoCategoryID").html(data);
                $("#cboParentVideoCategoryID").trigger("chosen:updated");
            });
        });
    ...
    function mybindingData() {
        ...
        if ("<%=action%>" == "edit") {
            ...
            $("#cboUsedState").select2("val", "<%=objItemET.UsedState%>");
            $("#cboParentVideoCategoryID").select2("val", "<%=objItemET.ParentVideoCategoryID%>");
        }
