...
{ 
    ...
    public class wpWebEN_Photo : WebPart
    {
        private const string _ascxPath = @"~/Usercontrols_EN/ucPhoto.ascx";
        ucPhoto _uc = new ucPhoto();
        protected override void CreateChildControls()
        {
            _uc = (ucPhoto)Page.LoadControl(_ascxPath);
        ...
        public string MainImageSize { get { return _mainImageSize; }
