<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucVideo.ascx.cs" Inherits="Pvn2.Web.Usercontrols_EN.ucVideo" %>
...
<div class="main-content clearfix ">
    <div class="post-2061 page type-page status-publish hentry content">
        ...
        <div class="navigator_bar">
            <div class="container">
                <uc1:ucBreadcumbMEDIA runat="server" id="ucBreadcumbMEDIA" MenuType="2" />
            </div>
        </div>
