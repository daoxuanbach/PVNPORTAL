<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNewsListMain.ascx.cs" Inherits="Pvn2.Web.Usercontrols_EN.ucNewsListMain" %>
<div class="container-fluid">
    <div class="container">
                    <div class="inner-column">
                        <div id="element-107" class="section-head left layout-petro">
                           <div class="grid-column col-xs-12">
                                <h2 class="section-main-title_css"><%=TieuDe %></h2>
                            </div>
                        </div>
